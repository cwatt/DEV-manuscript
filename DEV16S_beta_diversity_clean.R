#######################
#DEV 16S beta diversity
#Cassandra Wattenburger

#NOTES: 
#This code analyzes beta diversity
#Uses files generated in "DEV16S_phyloseq_prep_clean.R"
...
#I'm choosing to use bray-curtis because it is not dependent on phylogenetic distance, which shoudn't be used with ITS data
#to stay consistent, I'm using bray-curtis rather than unifrac distance for 16S data as well
