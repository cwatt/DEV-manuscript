The scripts in this directory can be used to recreate the results and figures from the manuscript, Agricultural Management Affects Root-Associated Microbiome Recruitment over Maize Development (2019).
